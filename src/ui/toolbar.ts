    ...
    wrapper.innerHTML = `
      <div class="primary-toolbar">
        <div class="toolbar-group">
          ...
          <button class="btn" id="save-flatten-btn" title="Flatten & Lock Form Fields upon Save (Ctrl+Shift+S)" aria-label="Flatten & Lock Form Fields upon Save (Ctrl+Shift+S)">
      ...
      <div class="annotation-toolbar">
        <div class="toolbar-group">
          ...
          <button class="icon-btn tool-btn" data-tool="freehand_highlight" title="Chisel Freehand Highlighter (Shift+L)" aria-label="Chisel Freehand Highlighter (Shift+L)">
